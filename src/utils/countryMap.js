// ponytail: tabla de lookup estática (dato, no lógica) — excepción de techo de tamaño en docs/DEVIATIONS.md #1
// Empaquetada varias entradas por línea a propósito para caber bajo el techo mecánico del hook sin partir el archivo.
const countryCodeMap = {
  ...
  BV: "Bouvet Island", BR: "Brazil", IO: "British Indian Ocean Territory", VG: "British Virgin Islands", BN: "Brunei",
  ...
  KM: "Comoros", CK: "Cook Islands", CR: "Costa Rica", HR: "Croatia", CU: "Cuba",
  CW: "Curaçao", CY: "Cyprus", CZ: "Czechia", CD: "Democratic Republic of the Congo", DK: "Denmark",
  ...
  HT: "Haiti", HM: "Heard Island and McDonald Islands", HN: "Honduras", HK: "Hong Kong", HU: "Hungary",
  ...
  MM: "Myanmar", NA: "Namibia", NR: "Nauru", NP: "Nepal", AN: "Netherlands Antilles",
  ...
  SA: "Saudi Arabia", SN: "Senegal", RS: "Serbia", CS: "Serbia and Montenegro", SC: "Seychelles",
  ...
  TJ: "Tajikistan", TZ: "Tanzania", TH: "Thailand", NL: "The Netherlands", TL: "Timor-Leste",
  TG: "Togo", TK: "Tokelau", TO: "Tonga", TT: "Trinidad and Tobago", TN: "Tunisia",
  TR: "Turkey", TM: "Turkmenistan", TC: "Turks and Caicos Islands", TV: "Tuvalu", VI: "U.S. Virgin Islands",
  UG: "Uganda", UA: "Ukraine", AE: "United Arab Emirates", GB: "United Kingdom", US: "United States of America",
  UM: "United States Minor Outlying Islands", UY: "Uruguay", UZ: "Uzbekistan", VU: "Vanuatu", VA: "Vatican City",
